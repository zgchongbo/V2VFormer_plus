...
class LocalFusionBlockMask(nn.Module):
    """
    ...
    def __init__(self,
                 ...
                 agent_size,
                 drop_out):
        super(LocalFusionBlockMask, self).__init__()
...
class LocalFusionEncoder(nn.Module):
    ...
    def __init__(self, args):
        super(LocalFusionEncoder, self).__init__()
        ...
        for i in range(self.depth):
            if self.mask:
                block = LocalFusionBlockMask(input_dim,
                                    mlp_dim,
                                    dim_head,
                                    window_size,
                                    agent_size,
                ...
                block = LocalFusionBlock(input_dim,
                                        mlp_dim,
                                        dim_head,
                                        window_size,
                                        agent_size,
